            ...
            <div className="fixed flex flex-col top-0 left-0 w-64 bg-white h-full border-r">
                ...
                <div className="overflow-y-auto overflow-x-hidden flex-grow">
                    <ul className="flex flex-col py-4 h-full">
                        ...
                        <li>
                            <Link to="/admin/login" className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-orange-500 pr-6">
                                <span className="inline-flex justify-center items-center ml-4">
