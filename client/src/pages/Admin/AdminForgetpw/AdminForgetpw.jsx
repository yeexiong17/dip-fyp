...
export default function AdminForgetpw() {
   ...
   const handleSubmit = async (event) => {
      ...
      try {
         const response = await fetch('http://localhost:8000/admin/forget-password', {
            method: 'POST',
            headers: {
                        ...
                        <form onSubmit={(e) => handleSubmit(e)}>
                           <div className="grid gap-y-4">
                              ...
                              <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
                                 ...
                                 <Link to='/admin/login' className="ml-2 text-orange-500 decoration-2 hover:underline font-medium" href="#">
                                    Login here
                                 </Link>
                              </p>
                           </div>
