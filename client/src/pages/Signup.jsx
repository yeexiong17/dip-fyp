                  ...
                  <div className="w-full lg:w-1/2 py-16 px-12">
                     ...
                     <form onSubmit={handleSubmit}>
                        ...
                        <div className="mt-5">
                           ...
                           <span>
                              {' '}I accept the <a href="#" className="text-purple-500 font-semibold hover:underline">Terms of Use</a> & <a href="#" className="text-purple-500 font-semibold hover:underline">Privacy Policy</a>
                           </span>
                        </div>
                        
                        <div className="mt-5 flex flex-col gap-y-4">
                           <button className="w-full bg-purple-500 text-center text-white active:scale-[.98] active:duration-75 transition-all hover:scale-[1.01]  ease-in-out transform py-4 rounded-lg">Register Now</button>
                        </div>
